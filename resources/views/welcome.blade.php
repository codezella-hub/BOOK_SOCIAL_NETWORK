...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <!-- Events Section -->
    <section id="events" class="w-full lg:max-w-4xl max-w-[335px] my-10">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6 flex flex-col justify-between hover:shadow-lg transition">
                <div>
                    ...
                    @if($event->summary)
                    <p class="mb-2 text-gray-700">{{ $event->summary }}</p>
                    @endif
                </div>
                <div class="mt-4">
                    <a href="{{ route('events.show', $event->slug) }}" class="btn btn-primary w-full">View Details</a>
                </div>
            </div>
            @empty
            <div class="col-span-2 text-center text-gray-500">No public events available.</div>
            @endforelse
        </div>
    </section>
